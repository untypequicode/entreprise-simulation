...
class Entreprise:
    ...
    def SetProduits(self, produits: dict) -> None:
        """
    ...
    def SetDistributeur(self, distributeur: list) -> None:
        """
    ...
    def SetSalaires(self, salaires: int) -> None:
        """
    ...
    def GetDistributeur(self) -> Distributeur:
        """
    ...
    def RemoveProduit(self, id: str, produit: Produit) -> None:
        """
    ...
    def GetChiffreAffaire(self) -> float:
        """
    ...
    def SetChiffreAffaire(self) -> None:
        """
        ...
        for id in self.__m_produits:
            for produit in self.__m_produits[id]:
                self.__m_chiffre_affaire += (produit.GetVentesEnvisagees() * produit.GetPrixDeVente() -
                                             (produit.GetBudgetPublicitaire() + produit.GetPrixFournisseur() *
                                              produit.GetVentesEnvisagees() + produit.GetVentesEnvisagees() *
                                              produit.GetPrixDeVente() * self.__m_distributeur.GetMarge()))
